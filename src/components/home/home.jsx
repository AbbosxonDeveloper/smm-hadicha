        ...
        <div className={`${light ? 'dark px-3' : 'px-3'} ${menu ? 'ov-hid' : ''}`}>
            ...
            <div className={`${menu ? 'menu' : 'd-none'}`}>
                ...
                <Link className='text-decoration-none text-dark' to='./about'>
                    <button className='btn form-control btn-warning mb-3'>
                ...
                <Link className='text-decoration-none text-dark' to='./products'>
                    <button className='btn form-control btn-info mb-3'>
                ...
                <button className='btn form-control btn-danger mb-3'>
...
<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
  ...
  <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>
        ...
        <header className={`container ${light ? 'dark d-header' : 'header'}`}>
            ...
            {/* search */}
            <input placeholder='qidirish...' className={`${inp ? 'form-control inputS' : 'd-none'}`} type="text" />
            <i>
            ...
            <main className='container main'>
                <div className='what-smm text-center align-items-center'>
                    <div className={`position-fixed btn-time ${light ? 'btn btn-warning' : 'btn btn-dark'}`}>
                    <i>{time}</i>
                    </div>
                ...
                <p>
                "Ijtimoiy media marketingi" bu Snapchat, WhatsApp, Facebook, Twitter va Instagram-da SMM uchun eng keng tarqalgan ta'rifdir. Bu erda SMM haqida qo'shimcha ma'lumotlar:
"Kichik va o'rta ishlab chiqaruvchilar" SMM uchun yana bir ta'rifdir.                
</p>
                <div className="btn-links w-75 my-4">
            <button  className='btn btn-l btn-success'>
                <Link to='contact'>bog'lanish</Link>
            </button>
            <button  className='btn btn-l btn-warning'>
                <Link to='about'>biz haqimizda</Link>
            </button>
            <button  className='btn btn-l btn-info'>
        ...
        <div className="btn-links w-75 my-4 flex-wrap-wrap">
                <Link to='contact'>
            <button  className='btn link-btn btn-l btn-success'>
                    bog'lanish
            </button>
                    </Link>
                <Link to='about'>
            <button  className='btn link-btn btn-l btn-warning'>
                    biz haqimizda
            </button>
                    </Link>
                <Link to='products'>
            <button  className='btn link-btn btn-l btn-info'>
                    Mahsulotlar
            </button>
                    </Link>
        </div>
